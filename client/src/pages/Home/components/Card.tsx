...
export default function Card() {
  return (
    <div className='flex md:flex-row justify-center justify-center justify-items-center gap-5 container mx-auto flex-col'>
      <div className='md:w-80 md:h-56	m-0.5	 px-4 py-6 bg-primary-100/20  shadow-lg shadow-primary-100/30 rounded-lg'>
      ...
      <div className='md:w-80 md:h-56	m-0.5	 px-4 py-6 bg-secondary-400/20 shadow-lg shadow-secondary-400/30 rounded-lg'>
      ...
      <div className='md:w-80 md:h-56	m-0.5	 lg:px-4 px-3 py-6 bg-secondary-100/20 shadow-lg shadow-secondary-100/30 rounded-lg'>
