  ...
  return (
    <div className='flex md:space-x-3 md:flex-row flex-col space-y-4 md:space-y-0 space-x-0'>
      <Link to={ROUTES.SIGNUP}>
        <button className='font-bold text-gray-700 hover:bg-primary-200/90 rounded-lg border-2 hover:shadow-primary-200 shadow-md border-primary-200 text-sm px-4 py-2 text-center w-full md:w-auto'>
          Sign up
        </button>
      </Link>
