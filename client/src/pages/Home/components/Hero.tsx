  ...
  return (
    <section  className='py-20 mb-32 relative max-w-screen-xl mx-auto flex items-center justify-between xl:px-0 px-4'>
      ...
      className='flex flex-col items-start max-w-2xl'>
        ...
        <motion.p variants={itemSlideUp} className='text-gray-500 leading-loose max-w-md mb-4 z-10 md:mb-8 text-sm'>
        ...
        <motion.button variants={itemSlideUp} className='relative bg-primary-100 z-10 px-6 py-3 md:px-8 md:py-4 rounded-lg shadow-md shadow-primary-100 text-white capitalize font-bold text-sm hover:bg-primary-100/90'>
          Get Started
        </motion.button>
      </motion.div>
      <motion.div
