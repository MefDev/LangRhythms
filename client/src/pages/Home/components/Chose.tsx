    ...
    <section className='chose-container'>
      ...
      <div className='chose-steps-container'>
        <section>
          <section className='section'>
            ...
            <p>
              ...
              Choose your preferred dialect, set your pace, and personalize your
              learning path.
            </p>
          </section>
          <section className='section'>
        ...
        <section className='align-section section'>
          ...
          <h6>Comprehensive & Customizable Learning</h6>
          <p>
            Our platform accommodates learners of all proficiency levels. Choose
            your preferred dialect, set your pace, and personalize your learning
            path.
          </p>
        </section>
      </div>
